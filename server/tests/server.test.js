...
describe("POST/todos", () => {
  ...
  it("should not create todo with invalild body data", done => {
    request(app)
      .post("/todos")
      .send({})
      .expect(400)
...
/* describe -> it should ->request ->expect ->  custom expect -> done */
